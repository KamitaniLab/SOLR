function [ model ] = SOLRtrain_v8(feature,label)
...
%At v7, iteration was reduced to 10, and interir point method was used for
%mu.
%At v8, alpha iteration was corrected.
...
for index_iteration=1:10
    ...
    model=updateAlpha_v4(feature,label,model);
