function [ model ] = updateMu_v5(X,y,model)
...
%   Detailed explanation goes here
    ...
    options = optimoptions('fmincon','Algorithm','interior-point','Hessian','on','GradObj','on','Display','off','HessianFcn',hess4fmincon,'MaxIterations',10);    
